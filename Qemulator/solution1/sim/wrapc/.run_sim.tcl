...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "qemulator.autotvin.dat"
	set constFileTvOut       "qemulator.autotvout.dat"
	set constFileHdlTvIn     "qemulator.autohdltvin.dat"
	set constFileHdlTvOut    "qemulator.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
