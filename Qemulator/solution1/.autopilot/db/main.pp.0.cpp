...
using std::tgamma;
using std::trunc;
# 2 "Qemulator/main.cpp" 2
# 1 "D:/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot\\ap_fixed.h" 1
# 55 "D:/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot\\ap_fixed.h"
...
# 56 "D:/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot\\ap_fixed.h" 2
...
# 57 "D:/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot\\ap_int.h"
...
# 3 "Qemulator/main.cpp" 2
# 1 "D:/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot\\ap_int.h" 1
# 4 "Qemulator/main.cpp" 2
...
__attribute__((sdx_kernel("qemulator", 0))) void qemulator(const int_type1 action1, const int_type1 action2, fixed_type1 *reward1, fixed_type1 *reward2)
{
#line 16 "C:/Users/mlabadmin/Desktop/QMARL_FPGA/Qemulator/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=qemulator
# 11 "Qemulator/main.cpp"
...
#pragma HLS INTERFACE mode=ap_vld port=action1
 ...
 const int img_s = 8;
 VITIS_LOOP_34_1: for (int j=0; j<2; j++){
#pragma HLS UNROLL
 ...
 const int img_qs = 4;
 VITIS_LOOP_51_2: for (int i=0; i<4; i++){
#pragma HLS UNROLL
 ...
 const int img_os = 4;
 VITIS_LOOP_59_3: for (int i=0; i<4; i++){
#pragma HLS UNROLL
 ...
 fixed_type2 prob[4];
 VITIS_LOOP_66_4: for (int i=0; i<4; i++){
#pragma HLS UNROLL
